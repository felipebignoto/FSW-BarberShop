...
import img from '@/public/barbershop-map.png'
      ...
      <SheetContent className="px-0">
        ...
        <div className="px-5">
          <div className="relative h-[180px] w-full mt-6">
            <Image src={img} fill alt={booking.barbershop.name} />
              ...
              <Card className="">
                <CardContent className="p-3 flex gap-2">
                  ...
                  <div>
                    ...
                    <h2 className="text-xs overflow-hidden whitespace-nowrap text-ellipsis ">
